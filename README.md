# Авитоклон
Дипломный проект по курсу LearnPython на Flask.
...
- Приложение написано на фреймворке Flask на Python3.
- В качетве фронтэнд части используем Bootstrap.
- База данных - удаленный сервер PostgreSQL, в качестве инструмента работы с базой - SQLAlchemy.
- Тестирование приложения - Pytest.
